...
import org.example.datn_website_best.dto.response.ProductFavoriteRespone;
import org.example.datn_website_best.model.ProductFavorite;
...
public interface ProductFavoriteRepository extends JpaRepository<ProductFavorite,Long> {
    @Query("SELECT new org.example.datn_website_best.dto.response.ProductFavoriteRespone(" +
            "pf.id, " +
