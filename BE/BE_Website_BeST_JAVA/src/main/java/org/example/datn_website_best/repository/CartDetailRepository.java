...
import org.example.datn_website_best.dto.response.CartDetailResponse;
...
public interface CartDetailRepository extends JpaRepository<CartDetail, Long> {
    ...
    @Query("""
            SELECT new org.example.datn_website_best.dto.response.CartDetailResponse(
    ...
    @Query("""
            SELECT new org.example.datn_website_best.dto.response.CartDetailProductDetailResponse(
