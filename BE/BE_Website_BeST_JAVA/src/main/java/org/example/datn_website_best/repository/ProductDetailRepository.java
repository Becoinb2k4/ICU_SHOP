...
public interface ProductDetailRepository extends JpaRepository<ProductDetail, Long>, JpaSpecificationExecutor<ProductDetail> {
    ...
    @Query("SELECT new org.example.datn_website_best.dto.response.ProductDetailResponseByNam(" +
    ...
    @Query("SELECT NEW org.example.datn_website_best.dto.response.ProductPromotionResponse(" +
    ...
    @Query("SELECT new org.example.datn_website_best.dto.response.ProductViewCustomerReponse(" +
    ...
    @Query("SELECT new org.example.datn_website_best.dto.response.ProductViewCustomerReponseByQuang(" +
    ...
    @Query("SELECT NEW org.example.datn_website_best.dto.response.PayProductDetailResponse(" +
            "p.id, p.name, c.id, c.name, s.id, s.name, pd.id, pd.quantity, pd.price, " +
