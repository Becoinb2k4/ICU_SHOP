...
import { fetchAllTargetUserActive } from '../../../../../../redux/action/targetUserAction';
const InfoProduct = ({ product, setProduct, formErrors, setFormErrors }) => {
    ...
    useEffect(() => {
        ...
        dispatch(fetchAllTargetUserActive());
    }, [dispatch]);
    ...
    const validateForm = (fieldName, fieldValue) => {
        ...
        if (fieldName === "idTargetUser" && !fieldValue) {
            errors.idTargetUser = "Vui lòng chọn đối tượng sử dụng áo";
        } else {
            errors.idTargetUser = null;
        }
    ...
    return (
        <Container fluid>
            ...
            <Row>
                ...
                <Col className="m-3">
                    <Form.Group>
                        <Form.Label>Đối tượng sử dụng áo</Form.Label>
                        <Form.Select
                            name="idTargetUser"
                            value={product.idTargetUser}
                            onChange={handleChange}
                            onBlur={handleBlur}
                            isInvalid={formErrors.idTargetUser}
                        >
                            <option value="">Chọn đối tượng sử dụng áo</option>
