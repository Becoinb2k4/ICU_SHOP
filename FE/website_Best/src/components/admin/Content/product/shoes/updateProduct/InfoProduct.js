...
import { fetchAllTargetUser } from '../../../../../../redux/action/targetUserAction';
const InfoProduct = ({ product, setProduct, formErrors, setFormErrors }) => {
    ...
    const validateForm = (fieldName, fieldValue) => {
        ...
        if (fieldName === "idTargetUser" && !fieldValue) {
            errors.idTargetUser = "Vui lòng chọn Đối tượng sử dụng";
        } else {
    ...
    return (
        <Container fluid>
            ...
            <Row>
                ...
                <Col className="m-3">
                    <Form.Group>
                        <Form.Label>Đối tượng sử dụng</Form.Label>
                        <Form.Select
                            name="idTargetUser"
                        ...
                        >
                            ...
                            {targetUsers?.map((targetUser) => (
                                <option key={targetUser.id} value={targetUser.id}>
                                    {targetUser.name} {targetUser.status === "INACTIVE" ? "(Không hoạt động)" : ""}
                                </option>
                            ))}
                        </Form.Select>
                        <Form.Control.Feedback type="invalid">
