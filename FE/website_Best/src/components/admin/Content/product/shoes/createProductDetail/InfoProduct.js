      ...
      <Row>
        <Col className="m-3">
          <Form.Group>
            ...
            <Form.Select name="idBrand" value={product.idBrand} disabled>
        ...
        <Col className="m-3">
          <Form.Group>
            ...
            <Form.Select name="idTargetUser" value={product.idTargetUser} disabled>
          ...
          <Form.Group className="mt-3">
            ...
            <Form.Select name="idMaterial" value={product.idMaterial} disabled>
