...
const ModelUpdateProduct = () => {
    ...
    const isProductValid = () => {
        ...
        const requiredFields = ["name", "idBrand", "idCategory", "idMaterial", "idTargetUser"];
    ...
    const validateNewProduct = (newProduct) => {
        ...
        if (!newProduct.idTargetUser) {
            toast.error("Đối tượng sử dụng sản phẩm là bắt buộc");
            return false;
        }
    ...
    const handleSubmitUpdate = async () => {
        try {
            const updateProductRequest = {
                ...
                idTargetUser: product.idTargetUser,
                image: product.image,
